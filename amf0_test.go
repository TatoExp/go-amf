...
var encodeCases0 = []encodeTestCase{
	{3.14, []byte{0x00, 0x40, 0x09, 0x1e, 0xb8, 0x51, 0xeb, 0x85, 0x1f}},
	...
	{map[string]interface{}{
		...
		"four":  nil,
		"five":  true}, []byte{0x03,
		0x00, 0x04, 0x66, 0x69, 0x76, 0x65, 0x01, 0x01,
		0x00, 0x04, 0x66, 0x6f, 0x75, 0x72, 0x05,
		0x00, 0x03, 0x6f, 0x6e, 0x65, 0x00, 0x3f, 0xf0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x05, 0x74, 0x68, 0x72, 0x65, 0x65, 0x02, 0x00, 0x05, 0x74, 0x68, 0x72, 0x65, 0x65,
		0x00, 0x03, 0x74, 0x77, 0x6f, 0x00, 0x40, 0x09, 0x1e, 0xb8, 0x51, 0xeb, 0x85, 0x1f,
		0x00, 0x00, 0x09}},
	{ECMAArray(map[string]interface{}{
		...
		0x00, 0x01, 0x32, 0x00, 0x40, 0x09, 0x1e, 0xb8, 0x51, 0xeb, 0x85, 0x1f,
...
var decodeCases0 = []decodeTestCase{
	...
	{[]byte{0x03,
		...
		0x00, 0x05, 0x74, 0x68, 0x72, 0x65, 0x65, 0x02, 0x00, 0x05, 0x74, 0x68, 0x72, 0x65, 0x65,
		0x00, 0x03, 0x74, 0x77, 0x6f, 0x00, 0x40, 0x09, 0x1e, 0xb8, 0x51, 0xeb, 0x85, 0x1f,
		0x00, 0x00, 0x09}, 62, map[string]interface{}{
		"one":   1.0, // AMF0 only has Number
		"two":   3.14,
		"three": "three",
		"four":  nil,
		"five":  true}},
	{[]byte{0x08, 0x00, 0x00, 0x00, 0x05,
		...
		0x00, 0x01, 0x34, 0x05,
		0x00, 0x01, 0x35, 0x01, 0x01,
		0x00, 0x00, 0x09}, 52, ECMAArray(map[string]interface{}{
...
// func TestExternAMF0(t *testing.T) {
// 	testExtern(t, decodeCases0, "TestExternAMF0", 0)
// }
